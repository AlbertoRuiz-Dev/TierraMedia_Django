...
urlpatterns = [
    ...
    path('character/relationship_delete/', views.RelationshipDeleteView.as_view(), name='relationshipDeleteView'),
    path('character/relationship_update/', views.RelationshipUpdateView.as_view(), name='relationshipUpdateView'),
